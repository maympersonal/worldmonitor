...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  islaDeLaJuventud: { name: 'Isla de la Juventud', enabled: true, priority: 1 },
  mayabeque: { name: 'Mayabeque', enabled: true, priority: 1 },
  matanzas: { name: 'Matanzas', enabled: true, priority: 1 },
  cienfuegos: { name: 'Cienfuegos', enabled: true, priority: 1 },
  villaClara: { name: 'Villa Clara', enabled: true, priority: 1 },
  sanctiSpiritus: { name: 'Sancti Spíritus', enabled: true, priority: 1 },
  ciegoDeAvila: { name: 'Ciego de Ávila', enabled: true, priority: 1 },
  camaguey: { name: 'Camagüey', enabled: true, priority: 1 },
  lasTunas: { name: 'Las Tunas', enabled: true, priority: 1 },
  holguin: { name: 'Holguín', enabled: true, priority: 1 },
  granma: { name: 'Granma', enabled: true, priority: 1 },
  santiagoDeCuba: { name: 'Santiago de Cuba', enabled: true, priority: 1 },
  guantanamo: { name: 'Guantánamo', enabled: true, priority: 1 },
