...
const FULL_PANELS: Record<string, PanelConfig> = {
  ...
  cuba: { name: 'Cuba Tourism', enabled: true, priority: 1 },
  'cuba-brief': { name: 'Cuba Tourism Brief', enabled: true, priority: 1 },
  pinarDelRio: { name: 'Pinar del Río Tourism', enabled: true, priority: 1 },
  artemisa: { name: 'Artemisa Tourism', enabled: true, priority: 1 },
  laHabana: { name: 'Havana Tourism', enabled: true, priority: 1 },
  islaDeLaJuventud: { name: 'Isla de la Juventud Tourism', enabled: true, priority: 1 },
  mayabeque: { name: 'Mayabeque Tourism', enabled: true, priority: 1 },
  matanzas: { name: 'Matanzas Tourism', enabled: true, priority: 1 },
  cienfuegos: { name: 'Cienfuegos Tourism', enabled: true, priority: 1 },
  villaClara: { name: 'Villa Clara Tourism', enabled: true, priority: 1 },
  sanctiSpiritus: { name: 'Sancti Spíritus Tourism', enabled: true, priority: 1 },
  ciegoDeAvila: { name: 'Ciego de Ávila Tourism', enabled: true, priority: 1 },
  camaguey: { name: 'Camagüey Tourism', enabled: true, priority: 1 },
  lasTunas: { name: 'Las Tunas Tourism', enabled: true, priority: 1 },
  holguin: { name: 'Holguín Tourism', enabled: true, priority: 1 },
  granma: { name: 'Granma Tourism', enabled: true, priority: 1 },
  santiagoDeCuba: { name: 'Santiago de Cuba Tourism', enabled: true, priority: 1 },
  guantanamo: { name: 'Guantánamo Tourism', enabled: true, priority: 1 },
...
const TECH_PANELS: Record<string, PanelConfig> = {
  ...
  markets: { name: 'Tech Stocks', enabled: false, priority: 2 },
...
const FINANCE_PANELS: Record<string, PanelConfig> = {
  ...
  markets: { name: 'Live Markets', enabled: false, priority: 1 },
  ...
  commodities: { name: 'Commodities & Futures', enabled: false, priority: 1 },
  ...
  economic: { name: 'Economic Data', enabled: false, priority: 1 },
  'economic-news': { name: 'Economic News', enabled: true, priority: 2 },
  ipo: { name: 'IPOs, Earnings & M&A', enabled: true, priority: 1 },
  heatmap: { name: 'Sector Heatmap', enabled: false, priority: 1 },
  'macro-signals': { name: 'Market Radar', enabled: false, priority: 1 },
