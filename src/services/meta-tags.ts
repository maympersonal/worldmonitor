// Dynamic Meta Tags Service for monitor
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | monitor`;
...
function generateDescription(
  ...
  return `monitor ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
