// Dynamic Meta Tags Service for ottc
...
export function updateMetaTagsForStory(meta: StoryMeta): void {
  ...
  const title = `${countryName} Intelligence Brief | ottc`;
...
function generateDescription(
  ...
  return `ottc ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
